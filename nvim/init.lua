...
vim.keymap.set('n', '<leader>on', '<cmd>ObsidianNewFromTemplate<cr>', { desc = 'New Note' })
vim.keymap.set('n', '<leader>ow', '<cmd>ObsidianWorkspace<cr>', { desc = 'Workspace Change' })
vim.keymap.set('v', '<leader>or', '<cmd>ObsidianRename<cr>', { desc = 'Rename File' })
vim.keymap.set('v', '<leader>om', '<cmd>ObsidianLink<cr>', { desc = 'Create Link' })

-- Automatically sync with rclone on markdown file save
vim.api.nvim_create_autocmd('BufWritePost', {
  pattern = '*.md',
  callback = function()
    vim.fn.jobstart { 'bash', '/home/felipe/scripts/sync_obsidian.sh' }
  end,
})
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<space>e', ':Telescope file_browser<CR>', { desc = 'File browser' })
    ...
    config = function()
      require('obsidian').setup {
        ...
        workspaces = {
          {
            name = 'Notes',
            path = '~/Notes/Obsidian/Obsidian Notes/',
          },
          {
            name = 'Work',
            path = '~/Notes/Obsidian/Obsidian Work/',
          },
          {
            name = 'Personal',
            path = '~/Notes/Obsidian/Obsidian Personal/',
          },
        },
        templates = {
          folder = '/templates',
